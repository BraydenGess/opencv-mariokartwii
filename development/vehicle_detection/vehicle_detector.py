from development.vehicle_detection.train_vehicle_detector import SimpleCNN
import torch
...
class VehicleDetector:
    ...
    def predict(self, frame):
        classes = ['Bit Bike', 'Blue Falcon', 'Booster Seat', 'Bullet Bike', 'Cheep Charger', 'Classic Dragster',
                   ...
                   'Standard Bike M', 'Standard Bike S', 'Standard Kart L', 'Standard Kart M', 'Standard Kart S',
                   'Sugarscoot', 'Super Blooper', 'Tiny Titan', 'Wario Bike', 'Wild Wing', 'Zip Zip']
