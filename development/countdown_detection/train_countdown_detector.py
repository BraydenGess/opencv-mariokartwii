...
def main():
    ...
    # Load dataset
    dataset = datasets.ImageFolder(root="development/Images/Countdown/", transform=transform)
    ...
    torch.save(model.state_dict(), 'production/models/countdown_detection.pth')
    print('Model Saved')
